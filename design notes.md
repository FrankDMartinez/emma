			...
			1. Prepare the election scenario:
				...
				1. For Each Voter:
					1. For Each Candidate:
						1. Determine the actual utility of the Candidate to the Voter. (We can adjust this later to focus on mutiple issues.)
				...
				1. Identify honest Voters and strategic Voters
					1. Determine the number of Voters which vote honestly and the number which vote strategically.
						1. Determine the ideal ratio of Voters voting honestly to Voters voting strategically.
						1. Determine what ratio of honest Voters and of strategic Voters from the election's entire electorate most closely matches that ratio.
					1. Randomly select Voters to vote honestly or strategically in accordance with those numbers.
